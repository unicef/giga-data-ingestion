...
def upgrade() -> None:
    ...
    op.add_column('approval_request_audit_log', sa.Column('dq_mode', sa.Enum('uploaded', 'master', name='dqmodeenum'), nullable=False))
    op.add_column('approval_requests', sa.Column('dq_mode', sa.Enum('uploaded', 'master', name='dqmodeenum'), nullable=False))
