...
function Index() {
  ...
  return (
    ...
    <div >
      <div style={{ marginBottom: "2rem", background: "#fff", padding: "1rem", borderRadius: "4px" }}>
      <p style={{ fontWeight: 600, marginBottom: "0.5rem" }}>
        File: <a className="bx--link">{uploadData.original_filename}</a>
      </p>
      
      <p style={{ fontSize: "0.875rem", color: "#6f6f6f", marginBottom: "2rem" }}>
        Uploaded: {uploadData.uploader_email}<br />
        {new Date(uploadData.created).toLocaleTimeString()} GMT<br />
      ...
      <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '0.5rem' }}>
            <p>With Success: <strong>100</strong></p>
          </div>
          <Button 
            kind="primary" 
            size="sm"
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>1</p>
          <Button 
            kind="primary" 
            size="sm"
            renderIcon={Download}
